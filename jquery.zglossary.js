 ...
 * 
 * Version: 1.0.2.1 fork by Viktor Dite
 * This is an Fork which uses span elements instead of a hrefs
 * (c) Copyright 2011-2013, Zazar Ltd & Viktor Dite, Pixelrows
 * 
 * Description: jQuery plugin to find and display term definitions in HTML text
 * 
 * History:
 * 1.0.2.1 - uses span elements instead of a hrefs
